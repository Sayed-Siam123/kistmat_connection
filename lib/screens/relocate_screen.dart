...
class ReclocateScreen extends StatefulWidget {
  static String ID = "/relocate_screen";

  @override
  _ReclocateScreenState createState() => _ReclocateScreenState();
}

class _ReclocateScreenState extends State<ReclocateScreen> {
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        SvgPicture.asset("assets/svg/relocate.svg",
